    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 2 }}>
        ...
        >
          ...
          >
            <span style={{ color: "white", borderBottom: "2px solid #00aaff", paddingBottom: 18 }}>
              Home
            </span>
            <span>About</span>
            <span>Services</span>
          ...
          <div
            style={{ display: "flex", alignItems: "center", justifyContent: "flex-end", gap: 28 }}
          >
            <button
              onClick={enterApp}
              style={{
                ...
                borderRadius: 7,
                padding: "14px 22px",
                boxShadow: "0 0 22px rgba(0,136,255,.22)",
                cursor: "pointer",
                fontWeight: 900,
                fontSize: 15,
                textTransform: "uppercase",
        ...
        <section style={{ maxWidth: 650, marginBottom: 70 }}>
          ...
          >
            Forward Freedom Financial is built to help you take control of today, build wealth for
            tomorrow, and create the freedom to live life on your terms.
          </p>
          <div style={{ display: "flex", gap: 64 }}>
            <button
              ...
              style={{
                color: "white",
                background: "linear-gradient(90deg,#0077ff,#008cff)",
                border: "1px solid rgba(125,220,255,.55)",
                borderRadius: 8,
                padding: "17px 34px",
                boxShadow: "0 0 34px rgba(0,136,255,.48)",
                cursor: "pointer",
                fontWeight: 900,
                fontSize: 16,
                textTransform: "uppercase",
            ...
            >
              Build your Foundation <span style={{ marginLeft: 18, fontSize: 24 }}>→</span>
            </button>
            <button
              style={{
                color: "#f4f8ff",
            ...
            >
              Our Strategy <span style={{ color: "#00b7ff", marginLeft: 18, fontSize: 24 }}>→</span>
            </button>
          </div>
        </section>
        ...
        >
          <div>
            ...
            <div style={{ color: "white", fontSize: 34, lineHeight: 1.22, fontWeight: 800 }}>
              Moving Forward With
              <br />
              <span style={{ color: "#008cff" }}>Financial Freedom</span>
            </div>
          </div>
          <p
            style={{
          ...
          >
            ...
            through discipline, wisdom, and courageous action rooted in Jesus Christ.
            <br />
            <br />
            ...
            <br />
            <br />
            Our mission is to turn fear into strategy, debt into freedom, and money into a tool that
            empowers people to live boldly, give generously, and lead with conviction.
          </p>
        </section>
      </div>
    </div>
